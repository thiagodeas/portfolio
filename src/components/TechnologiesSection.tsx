...
export const TechnologiesSection = () => {
  return (
    <section
      id="tecnologias"
      className="w-full min-h-screen flex justify-center items-center gap-x-20"
      data-aos="fade-up"
    >
      <div className="flex flex-col items-center justify-center mt-10 max870:mt-20 w-[600px]">
        <h2 className="text-title font-semibold text-prim-text tracking-[2px] max620:text-[2.5rem] max480:text-[2rem]">
          Tecnologias
        </h2>
        <p className="text-[1.1rem] w-[700px] mb-10 text-details mt-4 text-center max720:w-[600px] max620:w-[500px] max550:w-[450px] max480:w-[350px] max400:text-[15px] max400:w-[300px]">
          Desenvolvi um amplo conjunto de habilidades em várias tecnologias e
          ferramentas ao longo da minha jornada até aqui, incluindo:
        </p>
        <div className="flex flex-row items-center justify-center gap-x-10 pb-4 border-soft-blue flex-wrap w-[900px] gap-y-10 max870:w-[600px] max620:w-[500px] max550:w-[450px] max480:w-[350px] max367:w-[300px]">
          ...
          <IconContainer>
            <FaAngular className="text-icons text-red-500 transition-all ease-in-out duration-500" />
            <p className="text-details text-sm">Angular</p>
          </IconContainer>
          ...
          <IconContainer>
            <FaAws className="text-icons text-white transition-all ease-in-out duration-500" />
            <p className="text-details text-sm">Amazon Web Services</p>
          </IconContainer>
        </div>
      </div>
    </section>
