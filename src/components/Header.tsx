...
export const Header = () => {
  return (
    <header className="w-full flex justify-around items-center h-20 bg-light-blue pl-3 pr-3 fixed top-0 left-0 z-50 bg-primary-blue">
      <NavLink href="inicio">
      <span className="text-span font-extrabold tracking-[3px] text-white hover:text-light-coral transition duration-700 ease-in-out no-underline focus:outline-none">&lt;thiagodeas /&gt;</span>
      </NavLink>
