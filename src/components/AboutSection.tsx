  ...
  return (
    <section id="sobre" className="flex w-full min-h-screen items-center justify-center gap-x-20 max1070:flex-col-reverse" data-aos="zoom-in-up">
      ...
      <div className="flex flex-col items-center justify-center w-[600px] text-center gap-y-5 max675:w-[550px] max620:w-[500px] max550:w-[450px] max480:w-[400px] max425:w-[350px] max425:gap-y-2 max375:w-[300px]">
        ...
        <p className="text-[1.1rem] tracking-wide max700:text-[1rem] max700:tracking-[0px] max425:text-[15px] max400:text-[14px]">Meu nome é Thiago, tenho 23 anos e sou graduando em Análise e Desenvolvimento de Sistemas pela Estácio. Iniciei minha trajetória na programação com Python, aprofundando-me posteriormente em JavaScript, TypeScript e React, com mais de um ano de dedicação ao desenvolvimento Front-End.</p>
        <p className="text-[1.1rem] tracking-wide max700:text-[1rem] max700:tracking-[0px] max425:text-[15px] max400:text-[14px]">Após essa experiência focada apenas em Front-End, decidi diversificar minhas habilidades e voltei meu foco para o Back-End. Atualmente, estou aprimorando meus conhecimentos em Java, buscando me tornar um profissional cada vez mais capacitado e completo no desenvolvimento de software.</p>
        <SocialMediaLinkAlt
